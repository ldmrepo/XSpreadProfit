...
export interface CoinInfo extends CoinBaseInfo {
    // 수집방법 요약북 : bookTicker, 오더북 : depth
    methodType: string // 수집 방법 (bookTicker, depth)
    // 상태 정보
...
/** 코인 정보 생성자 */
// simbol을 입력으로 받아 CoinInfo 객체를 생성하는 함수
export function buildCoinInfo(simbol: string): CoinInfo {
    return {
